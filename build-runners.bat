...
REM This script is used to pre-build the base Docker images for the built-in functions.

REM Build the image for the document to PDF converter function
...
REM Build the image for the image grayscale conversion function
...
REM Build the image for the image resizing function
